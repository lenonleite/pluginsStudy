	...
	class WF_Product_Import_Export_CSV {
		...
		public function wf_plugin_action_links( $links ) {
			$plugin_links = array(
				...
				'<a target="_blank" href="https://www.webtoffee.com/product/product-import-export-woocommerce/?utm_source=free_plugin_sidebar&utm_medium=Product_imp_exp_basic&utm_campaign=Product_Import_Export&utm_content='.WF_PIPE_CURRENT_VERSION.'" style="color:#3db634;"> ' . __( 'Premium Upgrade', 'product-import-export-for-woo' ) . '</a>',
