        ...
        <center style="margin-top: 20px;">
            <div class="panel panel-default" style="margin: 20px;">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-5">
    <img src="<?php echo plugins_url('elex-woocommerce-google-product-feed-plugin-basic\resources\prod-logo.png');?>" class="marketing_logos">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="<?php echo plugins_url('elex-woocommerce-google-product-feed-plugin-basic\resources\bulk_edit.png');?>" class="marketing_logos">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="<?php echo plugins_url('elex-woocommerce-google-product-feed-plugin-basic\resources\dynamic_pricing.png');?>" class="marketing_logos">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-md-12">
                                    <img src="<?php echo plugins_url('/elex-woocommerce-google-product-feed-plugin-basic\resources\wsdesk.png');?>" class="marketing_logos">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
