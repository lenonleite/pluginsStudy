...
if ( ! class_exists( 'Themify_Builder_Options' ) ) {
	...
	class Themify_Builder_Options {
		...
		public function builder_responsive_field() {
			...
			$out = sprintf( '<div class="themify-ui-slider clearfix"><div class="themify-slider-label label">%s</div><div class="label input-range width10"><div class="range-slider width8"></div><input type="text" name="%s" value="%s" data-min="%d" data-max="%d" class="width4"> px</div></div>',
