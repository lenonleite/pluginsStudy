...
final class Themify_Global_Styles{
	...
	public static function enqueue_admin_scripts(  ) {
		if ( isset($_GET['page']) && $_GET['page']==='themify-global-styles') {
			...
			wp_enqueue_style( 'themify-global-styles-css', themify_enque( THEMIFY_BUILDER_URI . '/css/editor/themify-global-styles.css' ), false, THEMIFY_VERSION );
			
			wp_enqueue_script( 'themify-global-styles-js', themify_enque( THEMIFY_BUILDER_URI . '/js/editor/themify-global-styles.js' ), null, THEMIFY_VERSION, true );
