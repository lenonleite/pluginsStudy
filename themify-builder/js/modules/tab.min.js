...
1;-1<h;--h){let a="false";f[h]!==k?f[h].classList.remove("current"):(f[h].classList.add("current"),a="true");f[h].setAttribute("aria-expanded",a)}k=null;for(f=g.length-1;-1<f;--f)g[f].parentNode===a&&(h="true",g[f].getAttribute("data-id")===b&&(k=g[f],h="false"),g[f].setAttribute("aria-hidden",h));c.innerText=this.innerText;c.click();d.trigger("tb_tabs_switch",[k,this,b])}});p=!0},q=function(){const a=window.location.hash.replace("#","");""!==a&&"#"!==a&&m.querySelector('.module-tab [data-id="'+a+
'"]')&&m.querySelector('.module-tab a[href="#'+a+'"]').click()};d.on("tfsmartresize",function(a){if(a){const e=m.querySelectorAll(".module-tab[data-tab-breakpoint]");var b=e.length;if(0<b){a=a.w;for(let c=b-1;0<c;--c)if(parseInt(e[c].getAttribute("data-tab-breakpoint"))>=a)d.LoadCss(n+"responsive.css",null,null,null,function(){e[c].classList.add("responsive-tab-style")});else{e[c].classList.remove("responsive-tab-style");b=e[c].getElementsByClassName("tab-nav");for(let a=b.length-1;-1<a;--a)b[a].classList.remove("right-align"),
b[a].classList.remove("center-align")}}}});d.on("tb_tab_init",function(a,b){a instanceof jQuery&&(a=a.get());for(let b=a.length-1;-1<b;--b){var e=l(a[b].getElementsByClassName("tab-nav")[0]),c=e.outerHeight();200<c&&e.siblings(".tab-content").css("min-height",c);e=a[b].classList;c="";!d.cssLazy.tb_tab_transparent&&e.contains("transparent")&&(d.cssLazy.tb_tab_transparent=!0,d.LoadCss(n+"transparent.css"));e.contains("minimal")?c="minimal":e.contains("panel")?c="panel":e.contains("vertical")&&(c="vertical");
""===c||d.cssLazy["tb_tab_"+c]||(d.cssLazy["tb_tab_"+c]=!0,d.LoadCss(n+c+".css"))}!0===b&&!1!==p||d.requestIdleCallback(r,50);window.addEventListener("hashchange",q,{passive:!0});d.requestIdleCallback(q,51)})})(jQuery,Themify,document);
