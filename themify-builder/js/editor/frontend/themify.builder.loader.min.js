...
e.className="dashicons dashicons-edit";e.setAttribute("data-id",l);k.appendChild(e);l=b[a].parentNode.classList;k.appendChild(c.createTextNode(l.contains("tbp_template")?tbLoaderVars.editTemplate:l.contains("tb_layout_part_wrap")?tbLoaderVars.turnOnLpBuilder:tbLoaderVars.turnOnBuilder));b[a].insertAdjacentElement(l.contains("tb_layout_part_wrap")||l.contains("tbp_template")?"beforeBegin":"afterEnd",k)}a||(a=c.getElementsByClassName("js-turn-on-builder")[0])||(d=a.getElementsByClassName("dashicons-edit")[0].getAttribute("data-id"));
!1===g?(d=null,a.classList.add("tb_disabled_turn_on")):a.classList.remove("tb_disabled_turn_on")}let m=0<g.location.href.indexOf("?")?"&":"?";m=g.location.href.replace(g.location.hash,"").replace("#","")+m+"tb-preview=1&ver="+g.themify_vars.version;a.body.on("click.tb_loading",".toggle_tb_builder:not(.tb_disabled_turn_on) > a, a.js-turn-on-builder",function(b){b.preventDefault();b.stopPropagation();const l=this.classList.contains("tb_restriction");a.LoadAsync(tbLocalScript.builder_url+"/js/editor/themify-ticks.js",
function(){l&&(TB_Ticks.init(tbLocalScript.ticks).show(),init())},null,null,function(){return!!g.TB_Ticks});a.body.off("click.tb_loading");if(!l){var r=this.classList.contains("js-turn-on-builder")?this.childNodes[0].getAttribute("data-id"):d;if(r&&!this.parentNode.classList.contains("tb_disabled_turn_on")){a.lazyDisable=a.lazyScrolling=!0;null!==a.observer&&a.observer.disconnect();var q=[],e=k(c).scrollTop(),h=a.convert(c.head.getElementsByTagName("link")).concat(a.convert(c.head.getElementsByTagName("style"))),
p=a.body.children(),w=c.createElement("div"),t=c.createElement("div"),x=c.createElement("div"),y=c.createElement("div"),v=c.createElement("div"),n=c.createElement("iframe");w.className="tb_workspace_container";t.className="tb_vertical_bars";x.id="tb_left_bar";y.id="tb_right_bar";x.className=y.className="tb_middle_bar";v.className="tb_vertical_change_tooltip";n.className="tb_iframe";n.id=n.name="tb_iframe";n.scrolling=a.isTouch?"no":"yes";n.src=m+"&tb-id="+r;a.off("builder_load_module_partial");k(c).off("ajaxComplete");
if(null!==tbLoaderVars.styles)for(var f in tbLoaderVars.styles)""!==tbLoaderVars.styles[f]&&(a.LoadCss(f,tbLoaderVars.styles[f]),q[f+"?ver="+tbLoaderVars.styles[f]]=1);var u=c.createElement("div");b=c.createElement("div");f=c.createElement("div");var A=c.getElementsByClassName("tb_front_icon")[0];u.id="tb_alert";u.className="tb_busy";b.id="tb_fixed_bottom_scroll";b.className="tb_fixed_scroll";f.id="builder_progress";f.appendChild(c.createElement("div"));c.body.insertAdjacentElement("afterbegin",b);
c.body.appendChild(u);A&&A.parentNode.appendChild(f);a.on("tb_load_iframe",function(){t.appendChild(x);t.appendChild(n);t.appendChild(y);t.appendChild(v);w.appendChild(t);n.addEventListener("load",function(){const b=this,d=b.contentWindow;let l;a.body.one("themify_builder_ready",function(b){k(u).fadeOut(100,function(){this.classList.remove("tb_busy")});b=a.body[0].classList.contains("archive");let f="themify_builder_active builder-breakpoint-desktop page-loaded";a.isTouch&&(f+=" tb_touch");b&&(f+=
" archive");"1"===tbLoaderVars.isGlobalStylePost&&(f+=" gs_post");a.body[0].className=f;a.body[0].removeAttribute("style");w.style.display="block";b=d.tb_app.Instances.Builder[0].$el.offset().top;b>e&&(e=b);d.scrollTo(0,e);a.iframe=n;a.is_builder_active=!0;setTimeout(function(){p.hide();for(var b=h.length-1;-1<b;--b)if(h[b]&&h[b].parentNode){var e=h[b].href,f=h[b].id;e?q[e]||-1!==e.indexOf("wp-includes")||-1!==e.indexOf("admin-bar")||(h[b].setAttribute("disabled",!0),h[b].parentNode.removeChild(h[b])):
"tf_fonts_style"!==f&&"tf_lazy_common"!==f&&h[b].parentNode.removeChild(h[b])}h=q=tbLoaderVars=u=null;k(".themify_builder_content,#wpadminbar,header").remove();p.filter("ul,a,video,audio").filter(":not(:has(link))").remove();b="scroll tfsmartresize debouncedresize throttledresize resize mouseenter keydown keyup mousedown assignVideo".split(" ");e=k(g);f=k(c);for(let c=b.length-1;-1<c;--c)e.off(b[c]),f.off(b[c]),a.body.off(b[c]);c.documentElement.removeAttribute("style");c.documentElement.removeAttribute("class");
