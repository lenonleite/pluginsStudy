	...
	if (isset($_POST['info_update'])) {
		...
		check_admin_referer('google-analyticator-update_settings');
				...
				if(isset( $_POST['ga_domain_names'])){
				    var_dump('bbbb',$_POST['ga_domain_names'],key_ga_uid);
                    ...
                    var_dump($all_domains[ $_POST[key_ga_uid] ],$_POST[key_ga_uid]);
				}
      ...
      <form method="post" action="<?php echo ga_analyticator_setting_url();?>">
        ...
        <table class="form-table" cellspacing="2" cellpadding="5" width="100%">
          ...
          <tr id="ga_ajax_accounts">
    		...
    		<?php
             	...
             	<?php }else{
    		    //LENON DONE
    			?><?php echo get_option( 'ga_domain_name' ); ?> -f <a href="<?php echo admin_url('/options-general.php?page=ga_reset'); ?>">deauthorize and reset the plugin</a>
    	...
    	<tr>
          ...
          <tr>
            ...
            <td><?php
    						echo "aaaa<input type='text' size='50' ";
...
<?php if ( $event_tracking != 'enableda' ) { ?>
    // LENON DONE
